...
# Método para ler uma palavra de forma aleatória no banco de palavras
def rand_palavra():
    
    # Lista de palavras para o jogo
    palavras = ['banana', 'abacate', 'uva', 'morango', 'laranja']
    
    # Escolhe randomicamente um palavra
...
def main():
    ...
    while not game.hangman_over():
        ...
        # Recebe impyut do terminal
        user_imput = input('\n Digite uma letra: ')
        
        # Verifica se a letra digitada faz parte da palavra
        game.guess(user_imput)
        
    # Verifica o status do jogo
    game.print_game_status()
    
    # De acordo om o status, imprime mensagem na tela para o usuário
    if game.hangman_won():
